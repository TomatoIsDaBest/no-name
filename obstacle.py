...
try:
    ...
    def draw():
        ...
        if start == False:               
            ...
            screen.draw.text("Choose difficulty",color = "white",topleft = (590,25))             
            screen.draw.text("All images, sounds and music I got from Google",color = "red",topleft = (430,550))
        ...
        if shopping == True:            
            ...
            screen.draw.text("Increase running speed by 1 (10 coins)",color = "black",topleft = (140,70))
            screen.draw.filled_rect(sell_button2,(255,255,255))
            screen.draw.text("Reduce gravity 5 (20 coins)",color = "black",topleft = (140,170))        
            ...
            screen.draw.text("Things you bought will disappear when you close the game",color = "yellow",topleft = (470,25))
